...
Planck time & $\cdots$ & $5.39 \cdot 10^{-44}$ sec & $\infty$\\ \hline
Theory of Everything & $\cdots$ & $10^{-43}$ sec & $10^{32}$\\ \hline
...
\label{evolutionoverview}
\end{table}
\pagebreak

\subsection{Big Bang} \label{clip1}
\begin{table}[htbp]
\begin{center}
\begin{tabular}{|c|c|c|c|} \hline
\textbf{Event/Epoch} & \textbf{Redshift}$z$ & \textbf{Time} & \textbf{Temp, K} \\ \hline
...
\end{tabular}
\end{center}
\caption{Clip 1 - The Big Bang $ (or E=MC^2)$}
\end{table}
\pagebreak

\subsection{Big Bang Nucleosynthesis} \label{clip2}
\begin{table}[htbp]
\begin{center}
\begin{tabular}{|c|c|c|c|} \hline
\textbf{Event/Epoch} & \textbf{Redshift}$z$ & \textbf{Time} & \textbf{Temp, K} \\ \hline
...
\end{tabular}
\end{center}
\caption{Clip 2 - Nucleosynthesis}
\end{table}
\pagebreak

\pagebreak
\subsection{Cosmic Microwave Background} \label{clip3}
\begin{table}[htbp]
\begin{center}
\begin{tabular}{|c|c|c|c|} \hline
\textbf{Event/Epoch} & \textbf{Redshift}$z$ & \textbf{Time} & \textbf{Temp, K} \\ \hline
...
\end{tabular}
\end{center}
\caption{Clip 3 - Cosmic Microwave Background}
\end{table}
\pagebreak

\subsection{14 Billion Years} \label{clip4}
\begin{table}[htbp]
\begin{center}
\begin{tabular}{|c|c|c|c|} \hline
\textbf{Event/Epoch} & \textbf{Redshift}$z$ & \textbf{Time} & \textbf{Temp, K} \\ \hline
...
\end{tabular}
\end{center}
\caption{Clip 4 - 14 billion years}
\end{table}
\pagebreak
